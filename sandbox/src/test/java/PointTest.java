...
public class PointTest {
    ...
    public void pointsInOneVerticalLine() {
        double factualDistance = Point.distance(new Point(5, 5), new Point(5, 1));
        double expectedDistance = 4.00;
        Assert.assertEquals(expectedDistance,factualDistance);
    }
    @Test
    public void pointsInOneHorizontalLine() {
        double factualDistance = Point.distance(new Point(1, 5), new Point(1, 8));
        double expectedDistance = 3.00;
        Assert.assertEquals(expectedDistance,factualDistance);
    }
    @Test
    public void pointsInOnePoint() {
        double factualDistance = Point.distance(new Point(0, 0), new Point(0, 0));
        double expectedDistance = 0.00;
        Assert.assertEquals(expectedDistance,factualDistance);
    }
    @Test
    public void points() {
        double factualDistance = Point.distance(new Point(3, 5), new Point(7, 8));
